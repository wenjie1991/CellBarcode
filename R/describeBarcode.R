...
#' 
#' bc_diversity evaluates sequence diversity metrics in the cleanBc
#' element of BarcodeObj object. Lorenz curve and
#' barcode frequency distribution figure can be generated by this function.
#'
...
#' \itemize{
#'   \item total_reads: total read number.
...
#'
#' \emph{Richness}: The unique barcodes number \eqn{R} evaluates the richness of
#' the barcodes.
#'
